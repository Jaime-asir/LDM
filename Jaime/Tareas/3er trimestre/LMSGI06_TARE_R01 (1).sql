...
ALTER TABLE `notas`	ADD CONSTRAINT `FK_alumn` FOREIGN KEY (`alum`) REFERENCES `alumnos` (`cod`);
ALTER TABLE `notas`	ADD CONSTRAINT `FK_asig` FOREIGN KEY (`asig`) REFERENCES `asignaturas` (`cod`);
